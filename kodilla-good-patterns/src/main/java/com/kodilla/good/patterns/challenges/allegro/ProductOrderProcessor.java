...
public class ProductOrderProcessor {
    ...
    public ProductOrderDTO process(ProductOrderRequest productOrderRequest) {
        ...
        return new ProductOrderDTO(productOrderRequest.getUser(), productOrderRequest.getOrderDate(), productOrderRequest.getProduct(), productOrderRequest.getQuantity(), isSuccessfullySold);
    }
